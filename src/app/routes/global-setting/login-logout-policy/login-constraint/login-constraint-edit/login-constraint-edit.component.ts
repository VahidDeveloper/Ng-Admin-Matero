...
import { objectEquality } from '@phoenix-front-apps/utils';
...
export class LoginConstraintEditComponent implements OnInit, OnDestroy {
   ...
   */
  @Input() editItems: Readonly<LoginConstraint>;
  /**
  ...
  watcherForm(): void {
    this.editForm.valueChanges
      .pipe(distinctUntilChanged(objectEquality), takeUntil(this._onDestroy))
      .subscribe(data => {
