...
export class PasswordListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'username', 'domain', 'identifierKey'];
  ...
  ngOnInit(): void {
    this._isPersonalPage = this._activatedRoute.snapshot.routeConfig?.path === 'personal';
  ...
  private _getList(): void {
    ...
    this._storedCredentialsService.getAllStoredPasswords(this._isPersonalPage!).subscribe({
      next: res => {
