...
import { LoginConstraint, KeyWithCustomTemplate, LoginConstraintConfigService } from '@shared';
...
export class LoginConstraintComponent implements OnInit {
   ...
   */
  loginConstraintFromData: LoginConstraint | undefined;
  /**
   * login constraint list
   */
  loginConstraint: LoginConstraint | undefined;
  /**
   ...
   */
  listOfItem: KeyWithCustomTemplate[] | undefined;
  /**
   * template sms to show in the list
   */
  @ViewChild('optSendMedia', { static: true })
  private _otpSendMedia: TemplateRef<any> | undefined;
  /**
   * template sms to show in the list
   */
  @ViewChild('modal', { static: true }) private _modalTemp: TemplateRef<any> | undefined;
